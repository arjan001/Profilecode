...
<head>
    <meta charset="utf-8">
    <title>PROFILECODE| Contact us</title>
    <!-- SEO Meta Tags-->
            ...
            <div class="card h-100">
              <div class="card-body text-center"><i class="ci-phone h3 mt-2 mb-4 text-primary"></i>
                ...
                <ul class="list-unstyled fs-sm mb-0">
                  ...
                  <li class="mb-0"><span class="text-muted me-1">Tech support:</span><a class="nav-link-style" href="tel:+254769401004">+254769401004</a></li>
                </ul>
              </div>
            </div>
          </div>
      ...
      <div class="container-fluid px-0" id="map">
        <div class="row g-0">
          <div class="col-lg-6 iframe-full-height-wrap">
            <iframe class="iframe-full-height" width="600" height="250" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15955.36460837961!2d36.79972893758502!3d-1.2681032269338388!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x182f173c0a1f9de7%3A0xad2c84df1f7f2ec8!2sWestlands%2C%20Nairobi!5e0!3m2!1sen!2ske!4v1710743903444!5m2!1sen!2ske"></iframe> 
          </div>
            ...
            <form class="needs-validation mb-3" novalidate>
              <div class="row g-3">
                ...
                <div class="col-sm-6">
                  ...
                  <input class="form-control" type="text" id="cf-phone" placeholder="+25478908765" required>
