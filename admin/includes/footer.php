      ...
      <div class="container pt-2 pb-3">
        <div class="row">
          <div class="col-md-6 text-center text-md-start mb-4">
            <div class="text-nowrap mb-3"><a class="d-inline-block align-middle mt-n2 me-2" href="#"><img class="d-block" src="../img/logo.png" width="117" alt="ProfileCode"></a></div>
      ...
      <div class="pt-5 bg-darker">
        <div class="container">
          ...
          <div class="d-md-flex justify-content-between pt-4">
            <div class="pb-4 fs-xs text-light opacity-50 text-center text-md-start">© All rights reserved. Made by <a class="text-light" href="https://profilecode.ke" target="_blank" rel="noopener">ProfileCode</a></div>
            <div class="widget widget-links widget-light pb-4">
              <ul class="widget-list d-flex flex-wrap justify-content-center justify-content-md-start">
                ...
                <li class="widget-list-item ms-4"><a class="widget-list-link fs-ms" href="../contact.php">Support</a></li>
