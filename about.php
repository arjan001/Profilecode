      ...
      <main class="container-fluid px-0">
        ...
        <section class="row g-0">
          ...
          <div class="col-md-6 px-3 px-md-5 py-5">
            <div class="mx-auto py-lg-5" style="max-width: 35rem;">
              <h2 class="h3 pb-3">We are ProfileCode</h2>
              <p class="fs-sm pb-3 text-muted">Profile Code – the ultimate solution for Content Creators in Kenya seeking to monetize their digital content. With a robust multi-vendor marketplace, Profile Code offers an extensive range of products such as tender files, academic and study material, social media files, marketing tools, and human resource materials. Our platform is designed to empower vendors with easy access to reach their target audience by creating their own personalized accounts where they can upload and competitively price their products using our simple online registration form.</p><a class="btn btn-primary btn-shadow" href="shop-grid-ls.html">View products</a>
            </div>
          </div>
        </section>
        <!-- Row: Delivery-->
        <section class="row g-0">
          ...
          <div class="col-md-6 px-3 px-md-5 py-5 order-md-1">
            <div class="mx-auto py-lg-5" style="max-width: 35rem;">
              <h2 class="h3 pb-3">Vendor. Quick File Approvals for Uploads</h2>
              <p class="fs-sm pb-3 text-muted">Whether you are a freelancer or a full-time content creator looking for new revenue streams, Profile Code assures seamless transactions between buyers and sellers while ensuring maximum security through our safe payment gateway. Join tens of other creators on Profile Code today and start earning from your passion!

Vendors’ earnings can be withdrawn to their BANK ACCOUNT within 12 hours. As a content creator, you know that time is money. Profile Code offers a one-stop shop for all your digital download needs in Kenya. Our multi-vendor marketplace features categories ranging from tender files to academic study materials, social media assets, marketing resources, Premium Chama Groups and human resource documents.</p><a class="btn btn-accent btn-shadow" href="#">Shipping details</a>
            </div>
          </div>
        </section>
        <!-- Row: Mobile app-->
